...
export const USER_REFREASH_TOKEN_SECRET_KEY =
  process.env.USER_REFREASH_TOKEN_SECRET_KEY!;
// Admin Signature
export const ADMIN_REFREASH_TOKEN_SECRET_KEY =
  process.env.ADMIN_REFREASH_TOKEN_SECRET_KEY!;
export const ADMIN_TOKEN_SECRET_KEY = process.env.ADMIN_TOKEN_SECRET_KEY!;
// Superviser Signature
export const SUPERVISER_REFREASH_TOKEN_SECRET_KEY =
  process.env.SUPERVISER_REFREASH_TOKEN_SECRET_KEY!;
export const SUPERVISER_TOKEN_SECRET_KEY =
  process.env.SUPERVISER_TOKEN_SECRET_KEY!;
// Expires Time
...
export const AWS_CLOUDFRONT_LINK = process.env.AWS_CLOUDFRONT_LINK!;
